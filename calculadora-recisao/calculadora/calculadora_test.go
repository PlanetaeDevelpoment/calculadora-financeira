...
func TestSaldoFérias(t *testing.T) {
	testCases := []struct {
		...
		{1000, 1444.44, calculadora.Date(2024, 1, 1), calculadora.Date(2025, 1, 1), calculadora.Trabalhado},
		{2000, 2888.89, calculadora.Date(2024, 1, 4), calculadora.Date(2025, 1, 4), calculadora.Trabalhado},
		{1500, 1833.33, calculadora.Date(2024, 1, 1), calculadora.Date(2024, 11, 1), calculadora.Trabalhado},
...
func TestSaldoDécimoTerceiro(t *testing.T) {
	...
	for _, tc := range testCases {
		t.Run(fmt.Sprintf("Teste de saldo de Décimo Terceiro: %+v", tc.salário), func(t *testing.T) {
